...
/**
 * Produce or consume xCal compliant XML.
 */
@Produces({MediaType.APPLICATION_XML})
@Consumes({MediaType.APPLICATION_XML})
//@Singleton
@Provider
public class XCalMessageProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
    ...
    public Object readFrom(Class<Object> type, Type genericType, Annotation[] annotations, MediaType mediaType,
        ...
        XmlMapper mapper;
        ContextResolver<XmlMapper> resolver = providers.getContextResolver(XmlMapper.class, mediaType);
        if (resolver != null) {
